...
import { AlertTriangle, TrendingUp, Users, Cpu, Check, Bell, MousePointer2 } from "lucide-react";
...
const scenarios: Scenario[] = [
  {
    notification: "Biggest client threatening to cancel",
    subtitle: "$5K/mo retainer · 14 days to save it",
    agentLabel: "CEO → CMO + CSO",
    agentLetter: "C",
    agentColor: "text-emerald-600",
    agentBg: "bg-emerald-100 border-emerald-300",
    result: "✓ 3 perspectives → retention angle drafted",
    icon: <AlertTriangle className="w-4 h-4 text-emerald-500" />,
  },
  {
    notification: "Should I raise prices on new retainers?",
    subtitle: "2 proposals pending · pricing decision",
    agentLabel: "CMO + CSO",
    agentLetter: "M",
    agentColor: "text-purple-600",
    agentBg: "bg-purple-100 border-purple-300",
    result: "✓ +15% with new package positioning",
    icon: <TrendingUp className="w-4 h-4 text-purple-500" />,
  },
  {
    notification: "Team burnout — 3rd quarter in a row",
    subtitle: "Bottleneck analysis needed",
    agentLabel: "COO · Theory of Constraints",
    agentLetter: "O",
    agentColor: "text-amber-600",
    agentBg: "bg-amber-100 border-amber-300",
    result: "✓ Fix: intake queue before AMs see leads",
    icon: <Users className="w-4 h-4 text-amber-500" />,
  },
  {
    notification: "Stack bleeding $2K/mo — what to cut?",
    subtitle: "12 SaaS tools · half barely used",
    agentLabel: "CTO · Stack Audit",
    agentLetter: "T",
    agentColor: "text-blue-600",
    agentBg: "bg-blue-100 border-blue-300",
    result: "✓ Cut 3 tools · save $1.4K/mo · keep 2 core",
...
export default function HeroBoardAnimation() {
  ...
  return (
    ...
    >
          ...
          <div className="relative w-48 h-72 bg-white rounded-[24px] border-2 border-slate-200 shadow-2xl overflow-hidden">
            ...
            <div className="p-4 flex flex-col h-[calc(100%-24px)]">
              ...
              >
                ...
                {/* Dispatch button with ripple + cursor */}
                <div className="relative">
                  {/* Ripple */}
                  {phase === "dispatch" && (
                    <div
      ...
      {/* ── STEP 3: Exec dispatches outward ── */}
      <div
      ...
      >
        ...
        <div className="text-center mt-2">
          <p className="text-[10px] font-bold text-slate-500 whitespace-nowrap">{s.agentLabel}</p>
          <div
